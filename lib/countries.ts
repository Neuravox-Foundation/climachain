...
export const COUNTRY_BBOX: Record<string, { minLon: number; minLat: number; maxLon: number; maxLat: number }> = {
  ...
  // West/Central Africa fillers
  BEN: { minLon: 0.8, minLat: 6.2, maxLon: 3.9, maxLat: 12.4 },
  BFA: { minLon: -5.5, minLat: 9.4, maxLon: 2.4, maxLat: 15.1 },
  CPV: { minLon: -25.4, minLat: 14.8, maxLon: -22.7, maxLat: 17.2 },
  GMB: { minLon: -16.8, minLat: 13.1, maxLon: -13.8, maxLat: 13.8 },
  GIN: { minLon: -15.1, minLat: 7.2, maxLon: -7.6, maxLat: 12.7 },
  GNB: { minLon: -16.7, minLat: 10.9, maxLon: -13.6, maxLat: 12.7 },
  LBR: { minLon: -11.5, minLat: 4.4, maxLon: -7.4, maxLat: 8.6 },
  MLI: { minLon: -12.2, minLat: 10.2, maxLon: 4.2, maxLat: 24.9 },
  MRT: { minLon: -17.1, minLat: 14.7, maxLon: -4.8, maxLat: 27.3 },
  NER: { minLon: 0.2, minLat: 11.7, maxLon: 16.0, maxLat: 23.5 },
  SLE: { minLon: -13.3, minLat: 6.9, maxLon: -10.3, maxLat: 10.0 },
  TGO: { minLon: -0.1, minLat: 6.1, maxLon: 1.8, maxLat: 11.1 },
  CAF: { minLon: 14.4, minLat: 2.2, maxLon: 27.5, maxLat: 11.0 },
  TCD: { minLon: 13.4, minLat: 7.4, maxLon: 24.0, maxLat: 23.5 },
  GNQ: { minLon: 8.5, minLat: -1.5, maxLon: 11.3, maxLat: 3.8 },
  COG: { minLon: 11.2, minLat: -5.0, maxLon: 18.6, maxLat: 3.7 },
  STP: { minLon: 6.5, minLat: 0.0, maxLon: 7.5, maxLat: 1.7 },
  // East Africa fillers
  BDI: { minLon: 28.9, minLat: -4.5, maxLon: 30.9, maxLat: -2.3 },
  COM: { minLon: 43.2, minLat: -12.5, maxLon: 44.6, maxLat: -11.3 },
  DJI: { minLon: 41.7, minLat: 10.9, maxLon: 43.5, maxLat: 12.7 },
  ERI: { minLon: 36.4, minLat: 12.4, maxLon: 43.3, maxLat: 18.0 },
  MWI: { minLon: 32.7, minLat: -17.1, maxLon: 35.9, maxLat: -9.4 },
  MUS: { minLon: 57.2, minLat: -20.6, maxLon: 57.8, maxLat: -19.9 },
  SYC: { minLon: 46.2, minLat: -10.0, maxLon: 56.3, maxLat: -3.7 },
  SOM: { minLon: 40.9, minLat: -1.7, maxLon: 51.4, maxLat: 11.9 },
  SSD: { minLon: 23.4, minLat: 3.5, maxLon: 35.9, maxLat: 12.2 },
  // Southern Africa fillers
  SWZ: { minLon: 30.7, minLat: -27.3, maxLon: 32.1, maxLat: -25.7 },
  LSO: { minLon: 27.0, minLat: -30.7, maxLon: 29.5, maxLat: -28.6 },
}
